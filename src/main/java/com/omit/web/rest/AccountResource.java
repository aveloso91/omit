...
import com.omit.domain.PersistentToken;
import com.omit.domain.User;
import com.omit.repository.PersistentTokenRepository;
import com.omit.repository.UserRepository;
import com.omit.security.SecurityUtils;
import com.omit.service.MailService;
import com.omit.service.UserService;
import com.omit.service.dto.UserDTO;
import com.omit.web.rest.vm.KeyAndPasswordVM;
import com.omit.web.rest.vm.ManagedUserVM;
...
public class AccountResource {
                ...
                .orElseGet(() -> {
                    User user = userService
                        .createUser(managedUserVM.getLogin(), managedUserVM.getPassword(), managedUserVM.getFirstName(),
                            managedUserVM.getLastName(),managedUserVM.getSecondLastName(), managedUserVM.getDni(),
    ...
    public ResponseEntity saveAccount(@Valid @RequestBody UserDTO userDTO) {
        ...
        return userRepository
            ...
            .map(u -> {
                userService.updateUser(userDTO.getFirstName(), userDTO.getLastName(), userDTO.getSecondLastName(), userDTO.getDni(),
